...
export const FoodBox = () => {
  ...
  return (
    <>
        <div className={classNames("mx-auto overflow-x-hidden w-full max-w-[800px] ml-[200px] justify-center items-center h-screen flex absolute max-h-full top-0",{
          "animate-[HomeRightAnimation_1s_ease-out] transition-all duration-150 ease-in-out":foodBox.name,
          'hidden' : load === true,
        })}>
        ...
        <div className={classNames("flex mt-[110px] items-center justify-center w-full h-screen max-h-full bg-white",{
          'hidden' : load === false
        })}>
