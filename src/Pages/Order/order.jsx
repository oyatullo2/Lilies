export const Order = () => {
  ...
  return (
    <>
      <div className="w-full max-w-[700px] max-h-[800px] pb-[10px] overflow-y-scroll mx-auto flex h-full flex-col">
        ...
        <div className="flex justify-between mb-[36px] w-full">
          ...
          <div className="w-full flex justify-around">
            ...
            <p className="text-[#000000B0] text-[13px] font-[500]">Status</p>
          </div>
        </div>
        <div className="w-full gap-[40px] flex flex-col">
          <div className="w-full flex items-center justify-between">
            ...
            <div className="w-full flex justify-evenly">
              ...
              <p className="text-[15px] font-[600] text-[#3A8F4D]">Delivered</p>
            </div>
          </div>
          <div className="w-full flex items-center justify-between">
            <div className="w-full flex items-center gap-[15px]">
          ...
          <div className="w-full flex items-center justify-between">
            ...
            <div className="w-full flex justify-evenly">
              <p className="text-[17px] font-[700] text-[#00302E]">3</p>
              <p className="text-[17px] font-[700] text-[#00302E]">N,1000.00</p>
              <p className="text-[15px] font-[600] text-[#FF3A44]">Cooking</p>
            </div>
          </div>
          <div className="w-full flex items-center justify-between">
            <div className="w-full flex items-center gap-[15px]">
